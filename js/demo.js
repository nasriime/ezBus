...
$(document).ready(function (e) {
    ...
    var busDriver = firebase.database().ref('BusDriver');
    busDriver.on('value', function(snapshot) {
    ...
    var student = firebase.database().ref('Student');
    ...
    //
    var defaultKey = "0b62a5f8-f56f-4f33-a54d-9d31d165ffb8";
    var profile = "car";
...
function setupRouteOptimizationAPI(map, ghOptimization, ghRouting) {
    ...
    var addPointToMap = function (lat, lng, index) {
        ...
        if (index === 0) {
            ...
            }).bindPopup("hello").addTo(routingLayer);
        } else {
            new L.Marker([lat, lng], {
